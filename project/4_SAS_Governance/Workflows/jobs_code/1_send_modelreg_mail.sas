filename logfile '/home/sasdemo/modelops_credit_scoring_docker/WFsendmail1.log';
...
{ 
   ...
   "content":[ 
      { 
         "type":"text/plain",
         "value":"value":"The Candidate Champion is registred into the SAS Model Manager. You will receive an email with Model report!"
      }
   ]
}
;
