filename logfile '/home/sasdemo/modelops_credit_scoring_docker/WFsendmail3.log';
...
{ 
   ...
   "subject":"SAS Model Governance: Mail service - Model delivery service",
   "content":[ 
      { 
         "type":"text/plain",
         "value":"value":" The Champion model image is successfully registered into Docker registry"
      }
   ]
}
;
